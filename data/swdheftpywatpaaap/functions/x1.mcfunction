...
#欲扬先抑好方法
execute anchored eyes run fill ~-6 ~-6 ~-6 ~6 ~6 ~6 command_block{auto:1b,Command:"execute align xyz positioned ~0.5 ~ ~0.5 run function swdheftpywatpaaap:x1cb"} replace water[level=0]
#命令方块替换水
